...
...
...               Test login with ${USEREMAIL} positive and negative test scenario.
...
...
user access my appointments
    ...
    #Wait Until Element Is Not Visible    id:appointmentTable_wrapper
    #Wait Until Element Is Visible    id:appointmentTable_wrapper
    #Capture Page Screenshot    user-appointmentTable_wrapper-{index}.png
    #Click Element    id:m_aside_left_offcanvas_toggle
    #Click Link    /logout
    LogoutKW

...
Draw up account
    ...
    Click Element    xpath://a[@id='drawupaccount']
    admin draw up account page
    ...
    Element Should Be Visible    xpath://span[@class='dtr-title'][contains(text(),'Fee')]
...
Doctors wallet
    ...
    Element Text Should Be    xpath://div[2]/div[1]/div[2]/h1[2]    0.00€

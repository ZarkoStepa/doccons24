...
...
...               Assert and verify login page, specialities page, add new specialities modal, delete specialities modal dialog
...
Create Specialities - sucess
    ...
    Capture Page Screenshot    admin-create-specialities-sucessfuly-{index}.png
    Sleep    2
    ${alert-success} =    Get Text    class:alert-success
    Log To Console    ${alert-success}

Create Specialities - fail
    [Tags]    admin.add.speciality
    Click Element    xpath://button[@class='btn btn-success']
    Admin Add new speciality
    Input Text    name:name    ${name_cert}
...
Delete Specilalities - sucess
    [Tags]    admin.add.speciality
    Delete Specialities modal
    Click Element    xpath://button[contains(text(),'Delete')]
    Sleep    1
    ${alert-success} =    Get Text    class:alert-success
    Log To Console    ${alert-success}
    Capture Page Screenshot    after-delete-speciality-{index}.png
    LogoutKW

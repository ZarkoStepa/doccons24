...
Create a clinic - success
    ...
    Wait Until Element Is Visible    xpath://a[contains(text(),'Qualifications')]
    Click Element    xpath://a[contains(text(),'Qualifications')]
    Wait Until Element Is Visible    css:.form-group:nth-child(6) .m-radio:nth-child(1) > span
    ...
    Wait Until Element Is Visible    css:.col-2 > .btn

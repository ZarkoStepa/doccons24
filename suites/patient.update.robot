...
user update all required fields for location - success
    [Tags]    patient.update
    Click Element    id:m_aside_left_offcanvas_toggle
    Wait Until Element Is Visible    xpath://span[contains(text(),'Profile')]
    Click Link    /profile
